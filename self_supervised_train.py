...
def run(args):
    ...
    load_path = '/Users/Han/Desktop/capstone/JaPyGuri-AI/pre_trained_parameter/noise_patch_ssl/noise_ssl_patch_199.pth'
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % args.val_freq == 0 or epoch == args.epochs - 1:
            ...
            if epoch % 2 == 1:
                torch.save(model_state_dict, os.path.join(save_dir, '{}.pth'.format(epoch+200)))
        epoch -= 200
        # Scheduler Step
        scheduler.step()
